...
namespace Roguelight.Core
{
    ...
    {// http://paletton.com/#uid=73d0u0k5qgb2NnT41jT74c8bJ8X
        ...
        public static RLColor DbGrassFov = new RLColor(119, 180, 54);
        public static RLColor DbGrass = new RLColor(99, 160, 34);
        public static RLColor DbTreeFov = new RLColor(119, 180, 54);
        public static RLColor DbTree = new RLColor(99, 160, 34);
        ...
        public static RLColor White = new RLColor(255, 255, 255);
        public static RLColor Gray = new RLColor(90, 90, 90);
        public static RLColor GrayYellowed = new RLColor(177, 177, 173);
        public static RLColor Black = new RLColor(5, 5, 5);
        public static RLColor Beige = new RLColor(105, 100, 87);
        public static RLColor BeigeDarker = new RLColor(79, 75, 67);
        public static RLColor Muave = new RLColor(74, 65, 78);
        public static RLColor MuaveDarker = new RLColor(51, 45, 54);
        public static RLColor Indigo = new RLColor(32, 35, 50);
    }
}
